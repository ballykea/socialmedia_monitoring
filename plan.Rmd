...
### Aditional Monitoring Info ###
* Opening band: Live @Freaks4Live
* Graphics package by: Creative Works London @CreativeWorksUK
* Venue management: @LJVMColiseum  (BB&T Field actual location)
* Concert ticket sales: @LiveNationNCSC

I plan to monitor mentions of these Twitter accounts along with hashtags per below.
...
Any emergency alerts and info to audience from the promotional folks will come through #LIVENATION.
...
* Storify (https://storify.com) Capture and report your hashtag’s results, or curate the best user content.
...
I am still working out a scheme for collection of some important data - maybe a VOST worksheet or simple GoogleForm. Or just entry into WebEOC. TBD.
