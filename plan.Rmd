...
* #FlorenceNC raleigh  (as needed)
* #FlorenceNC wilmington  (as needed)
* #Florence
* #ReadyForsythFlorence
* #HurricanFlorence  - noticed this was trending on Twitter pm 13SEP - realized Hurrican is Spanish Lang spelling (w/o accent mark) also possibly "local places are deliberately misspelling the hashtag as a way to localize informational tweets to their area"
...
* FEMA Rumor Control https://www.fema.gov/florence-rumors
* Hurricane Florence Google Crisis Map (http://google.org/crisismap/2018-florence) Google has launched a Crisis Map for Hurricane Florence including storm path, evacuation routes, road closures and shelter information from @waze

#### Specific to this type event/hazard ####
##### Flood #####
* NC Flood Risk Information System https://fris.nc.gov/fris/
* Real-time flood info - NC Flood Inundation Mapping and Alert Network https://fiman.nc.gov/fiman/
##### Power Outages #####
* Duke Energy Outage Map https://www.duke-energy.com/outages/current-outages
* NN Power Outages Map (by Bluefire Studios) https://poweroutage.us/area/state/north%20carolina
